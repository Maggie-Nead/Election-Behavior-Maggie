...
```{r interestplots, fig.width=5, fig.height =4, echo=FALSE,fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
plot(interestModel)
...
```{r partyReelections, fig.width=5, fig.height=4, echo=FALSE,fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1)) 
plot(partyModel)
...
```{r partyconcorp, fig.width=5, fig.height=4, echo=FALSE,fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
plot(partyLetter)
```
...
```{r interaction, fig.width=5, fig.height=4, echo=FALSE,fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
