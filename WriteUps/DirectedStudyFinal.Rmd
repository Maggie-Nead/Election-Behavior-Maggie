...
```{r interestplots, fig.width=4, fig.height =4 }
plot(interestModel)
...
```{r partyReelections, fig.width=4, fig.height=4 }
 plot(partyModel)
...
```{r partyconcorp, fig.width=4, fig.height=4 }
plot(partyLetter)
```
...
```{r interaction, fig.width=4, fig.height=4 }
