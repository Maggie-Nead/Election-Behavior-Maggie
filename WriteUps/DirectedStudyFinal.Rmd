...
***Government and Nonprofit Service - Transactional*** This is similar to commericial service, but for municipal or state governments (including cities, counties, etc.) or non-business-oriented non-profit organizations (i.e. NOT ones that represents an industry or trade association).
...
```{r boxplot, fig.height=6, fig.width=5 }
...
```{r predictconst, fig.width=6, fig.height=6 }
values <- noI %>%
...
```{r interestplots, fig.width=5, fig.height =4 ,fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
plot(interestModel)
...
```{r partyReelections, fig.width=5, fig.height=4 ,fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1)) 
plot(partyModel)
...
```{r partyconcorp, fig.width=5, fig.height=4 ,fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
plot(partyLetter)
```
...
```{r interaction, fig.width=5, fig.height=4 ,fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
